...
import me.seunghak.restapiwithspring.accounts.AccountRepository;
import me.seunghak.restapiwithspring.accounts.AccountRole;
import me.seunghak.restapiwithspring.accounts.AccountService;
import me.seunghak.restapiwithspring.common.AppProperties;
...
public class EventControllerTests extends BaseTest {
    ...
    public void createEvent_Bad_Request_Wrong_Input() throws Exception {
        ...
        this.mockMvc.perform(post("/api/events/")
                ...
                //.andExpect(jsonPath("$[0].field").exists()) // TODO 글로벌 에러에서는 필드가 없어서 테스트 깨질 수 있다.
                .andExpect(jsonPath("content[0].defaultMessage").exists())
                .andExpect(jsonPath("content[0].code").exists())
                //.andExpect(jsonPath("$[0].rejectedValue").exists()) // TODO 글로벌 에러에서는 rejectedValue가 없어서 테스트 깨질 수 있다.
